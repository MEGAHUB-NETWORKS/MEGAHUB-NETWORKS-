...
window.MegaHub = {
  ...
  notify(txt) {
    ...
    n.className = 'glass';
    n.style.cssText = 'position:fixed; bottom:100px; left:50%; transform:translateX(-50%); padding:12px 24px; z-index:9999; border-left:4px solid #3b82f6; pointer-events:none; font-weight:950; animation: slide-up-fade 0.5s forwards; letter-spacing: 2px; text-transform: uppercase; font-size: 0.75rem;';
    n.textContent = txt;
...
window.onload = () => window.MegaHub.init();
